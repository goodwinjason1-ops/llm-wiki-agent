---
title: AI Quant Morning Brief - 2026-07-18
created: 2026-07-18
updated: 2026-07-17T22:54:30+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-18
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 63977.1000 | 0.23% | -0.30% | -0.82% | range/chop |
| ETHUSDT | 1839.3000 | -1.36% | 2.36% | 5.08% | bullish-momentum |
| SOLUSDT | 75.0100 | -0.39% | -3.99% | 4.12% | mixed |
...
- **Idea ID:** `2026-07-18-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: ETHUSDT 7d=2.36%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-3.99%, regime=mixed. Both directions are evidence; ETH remains a benchmark/control.
...
- **Idea ID:** `2026-07-18-QTF-MORNING-02`
...
- **Why now:** Screened example CASHCAT: funding annualized ≈ 319.57%, 24h volume ≈ $59,581,954. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-18-QTF-MORNING-03`
...
|---|---:|---:|---:|
| CASHCAT | 319.57% | $59,581,954 | 0.066511 |
| VVV | 121.19% | $6,142,657 | 11.1743 |
| MET | -121.88% | $1,164,219 | 0.1313 |
| XMR | 105.10% | $4,475,401 | 331.08 |
| FARTCOIN | -57.37% | $9,907,366 | 0.13306 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will the price of Bitcoin be between $58,000 and $60,000 on July 21? | $11,006 | 2026-07-21 |
| Will the price of Ethereum be above $1,500 on July 21? | $8,539 | 2026-07-21 |
| Microstrategy delisted from MSCI index by December 31? | $1,232 | 2027-01-01 |
| Will Carlos Roberto Massa Júnior finish in third place in the first round of the 2026 Brazilian presidential election? | $23,202 | 2026-10-04 |
...
```json
{
  "run_id": "20260717T225425Z",
  "generated_at": "2026-07-17T22:54:30+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-18-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: ETHUSDT 7d=2.36%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-3.99%, regime=mixed. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-18-QTF-MORNING-02",
      ...
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; CASHCAT is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example CASHCAT: funding annualized \u2248 319.57%, 24h volume \u2248 $59,581,954. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-18-QTF-MORNING-03",
