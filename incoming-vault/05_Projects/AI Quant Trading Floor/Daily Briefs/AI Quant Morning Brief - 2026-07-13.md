---
title: AI Quant Morning Brief - 2026-07-13
created: 2026-07-13
updated: 2026-07-12T20:00:09+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-13

> Stable navigation: [[AI Quant Morning Brief - Latest]]
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 64238.2000 | 0.66% | 0.94% | 1.04% | range/chop |
| ETHUSDT | 1821.6900 | 1.90% | 2.00% | 9.31% | range/chop |
| SOLUSDT | 77.7000 | 1.17% | -4.77% | 16.28% | mixed |

## Three candidate ideas

### 1. Tactical Crypto Regime Desk — ETHUSDT

- **Idea ID:** `2026-07-13-QTF-MORNING-01`
...
- **Why now:** ETHUSDT 7d=2.00%, 30d=9.31%, regime=range/chop.
...
- **Idea ID:** `2026-07-13-QTF-MORNING-02`
...
- **Why now:** CASHCAT funding annualized ≈ 807.06%, 24h volume ≈ $44,953,530.
...
- **Idea ID:** `2026-07-13-QTF-MORNING-03`
- **Source notes:** [[QTF-017 Morning Idea Generator from Second Brain]]
...
|---|---:|---:|---:|
| CASHCAT | 807.06% | $44,953,530 | 0.17129 |
| MINA | -53.81% | $1,364,724 | 0.043766 |
| TRUMP | -18.43% | $2,761,874 | 1.5772 |
| BTC | 10.95% | $737,982,152 | 64244.0 |
| WLFI | -19.15% | $1,106,187 | 0.057743 |
...
```json
{
  "run_id": "20260712T200004Z",
  "generated_at": "2026-07-12T20:00:09+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-13-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Watch ETHUSDT as the strongest 7-day regime candidate",
      "why_now": "ETHUSDT 7d=2.00%, 30d=9.31%, regime=range/chop.",
    ...
    {
      "idea_id": "2026-07-13-QTF-MORNING-02",
      ...
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Investigate extreme funding/open-interest candidate CASHCAT",
      "why_now": "CASHCAT funding annualized \u2248 807.06%, 24h volume \u2248 $44,953,530.",
    ...
    {
      "idea_id": "2026-07-13-QTF-MORNING-03",
