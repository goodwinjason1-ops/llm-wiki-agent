---
title: AI Quant Morning Brief - 2026-07-15
created: 2026-07-15
updated: 2026-07-15T03:10:31+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-15
...
> BTC, ETH and SOL are tracked here as control-universe diagnostics. A short-term return leader is not a standalone candidate or allocation decision; ETH remains a benchmark/control unless a separate rule passes its gates.

| Symbol | Close | 1D | 7D | 30D | Regime |
|---|---:|---:|---:|---:|---|
| BTCUSDT | 64625.7000 | -0.63% | 3.75% | -2.56% | mixed |
| ETHUSDT | 1868.4900 | -1.23% | 7.17% | 4.04% | mixed |
| SOLUSDT | 77.4000 | -0.60% | -0.57% | 4.62% | range/chop |
...
- **Idea ID:** `2026-07-15-QTF-MORNING-01`
...
- **Thesis:** Validate the pre-defined TTM-01 cross-sectional momentum rule; do not create an asset-specific thesis from recent returns.
- **Why now:** Current leader ETHUSDT: 7d=7.17%, 30d=4.04%, regime=mixed. This is diagnostic context only; ETH remains a benchmark/control.
...
### 2. Funding-Rate Extremes / Carry Validation Desk — Funding-rate-extremes universe (current screened example: CASHCAT)

- **Idea ID:** `2026-07-15-QTF-MORNING-02`
...
- **Thesis:** Test the pre-defined funding-rate-extremes / carry rule; CASHCAT is one currently screened observation, not the edge itself or a standing trade thesis.
- **Why now:** Screened example CASHCAT: funding annualized ≈ 692.55%, 24h volume ≈ $38,501,350. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-15-QTF-MORNING-03`
...
|---|---:|---:|---:|
| CASHCAT | 692.55% | $38,501,350 | 0.146107 |
| kBONK | -148.23% | $5,066,870 | 0.003755 |
| LIT | -40.29% | $33,981,133 | 2.6235 |
| HBAR | -38.78% | $1,568,702 | 0.067305 |
| BCH | -32.49% | $1,408,031 | 231.71 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will the price of Bitcoin be above $66,000 on July 17? | $18,800 | 2026-07-17 |
| Will Mark Rhoades Buckton win the 2026 Norfolk Police and Crime Commissioner by-election? | $14,869 | 2026-07-16 |
| Will the price of Bitcoin be between $58,000 and $60,000 on July 17? | $14,064 | 2026-07-17 |
| Will Carlos Roberto Massa Júnior finish in third place in the first round of the 2026 Brazilian presidential election? | $27,485 | 2026-10-04 |
...
```json
{
  "run_id": "20260715T031026Z",
  "generated_at": "2026-07-15T03:10:31+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-15-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule; do not create an asset-specific thesis from recent returns.",
      "why_now": "Current leader ETHUSDT: 7d=7.17%, 30d=4.04%, regime=mixed. This is diagnostic context only; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-15-QTF-MORNING-02",
      "desk": "Funding-Rate Extremes / Carry Validation Desk",
      "source_notes": [
        "[[CASHCAT Funding Persistence Evidence Review - 2026-07-14]]",
        "[[QTF Edge-First Production Mandate]]"
      ],
      "market": "Funding-rate-extremes universe (current screened example: CASHCAT)",
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; CASHCAT is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example CASHCAT: funding annualized \u2248 692.55%, 24h volume \u2248 $38,501,350. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-15-QTF-MORNING-03",
