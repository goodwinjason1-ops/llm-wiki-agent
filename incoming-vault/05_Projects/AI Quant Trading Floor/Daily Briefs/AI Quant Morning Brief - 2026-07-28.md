---
title: AI Quant Morning Brief - 2026-07-28
created: 2026-07-28
updated: 2026-07-27T20:00:11+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-28
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 65005.0000 | -0.61% | -0.39% | 8.30% | range/chop |
| ETHUSDT | 1949.9400 | -0.25% | 2.38% | 23.89% | bullish-momentum |
| SOLUSDT | 76.0300 | -0.96% | -2.35% | 7.86% | range/chop |
...
- **Idea ID:** `2026-07-28-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: ETHUSDT 7d=2.38%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-2.35%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.
...
- **Idea ID:** `2026-07-28-QTF-MORNING-02`
...
- **Why now:** Screened example CASHCAT: funding annualized ≈ 153.12%, 24h volume ≈ $9,308,659. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-28-QTF-MORNING-03`
...
|---|---:|---:|---:|
| CASHCAT | 153.12% | $9,308,659 | 0.037555 |
| NIL | -119.03% | $3,090,680 | 0.04116 |
| KAITO | -48.13% | $9,145,909 | 1.2427 |
| SPX | -48.83% | $1,227,063 | 0.3326 |
| APT | -35.05% | $1,572,254 | 0.6091 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will James Etzkorn advance to the general election for WA-01? | $7,502 | 2026-08-04 |
| Will South African inflation be between 2.6% and 2.9% in 2026? | $1,398 | 2027-01-20 |
...
```json
{
  "run_id": "20260727T200006Z",
  "generated_at": "2026-07-27T20:00:11+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-28-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: ETHUSDT 7d=2.38%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-2.35%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-28-QTF-MORNING-02",
      ...
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; CASHCAT is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example CASHCAT: funding annualized \u2248 153.12%, 24h volume \u2248 $9,308,659. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-28-QTF-MORNING-03",
