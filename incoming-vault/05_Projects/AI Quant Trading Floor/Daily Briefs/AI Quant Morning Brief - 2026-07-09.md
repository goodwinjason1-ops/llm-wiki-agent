---
title: AI Quant Morning Brief - 2026-07-09
created: 2026-07-09
updated: 2026-07-09T02:18:21+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-09
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 62032.4000 | -0.41% | 0.77% | 0.49% | range/chop |
| ETHUSDT | 1735.2500 | -0.47% | 2.03% | 5.84% | range/chop |
| SOLUSDT | 77.7100 | -0.17% | -3.73% | 19.59% | mixed |

## Three candidate ideas

### 1. Tactical Crypto Regime Desk — ETHUSDT

- **Idea ID:** `2026-07-09-QTF-MORNING-01`
...
- **Why now:** ETHUSDT 7d=2.03%, 30d=5.84%, regime=range/chop.
...
### 2. Alternative Venue / Funding Desk — CRV

- **Idea ID:** `2026-07-09-QTF-MORNING-02`
...
- **Thesis:** Investigate extreme funding/open-interest candidate CRV
- **Why now:** CRV funding annualized ≈ -42.26%, 24h volume ≈ $3,130,455.
...
- **Idea ID:** `2026-07-09-QTF-MORNING-03`
- **Source notes:** [[QTF-017 Morning Idea Generator from Second Brain]]
...
|---|---:|---:|---:|
| CRV | -42.26% | $3,130,455 | 0.20231 |
| LIT | -38.61% | $49,445,474 | 2.2626 |
| BLUR | -30.24% | $2,053,122 | 0.018209 |
| JTO | -28.26% | $7,368,710 | 0.63434 |
| KAITO | -24.37% | $8,815,882 | 0.6718 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will the price of Bitcoin be between $64,000 and $66,000 on July 11? | $15,738 | 2026-07-11 |
| Will New People (NL) win the most seats in the next Russian parliamentary election? | $90,489 | 2026-09-30 |
| Exact Score: Sandefjord Fotball 1 - 1 Hamarkameratene? | $2,106 | 2026-07-12 |
...
- [[X Bookmark Cap 1 - CyrilXBT AI Second Brain in 15 Minutes]] — score 4; Obsidian, agent, claim, source-limited; `03_Sources\x\X Bookmark Cap 1 - CyrilXBT AI Second Brain in 15 Minutes.md`
- [[QTF-016 Social Trading Claim Review Protocol]] — score 2; claim; `05_Projects\AI Quant Trading Floor\Strategies\QTF-016 Social Trading Claim Review Protocol.md`
...
```json
{
  "run_id": "20260709T021817Z",
  "generated_at": "2026-07-09T02:18:21+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-09-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Watch ETHUSDT as the strongest 7-day regime candidate",
      "why_now": "ETHUSDT 7d=2.03%, 30d=5.84%, regime=range/chop.",
    ...
    {
      "idea_id": "2026-07-09-QTF-MORNING-02",
      ...
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Investigate extreme funding/open-interest candidate CRV",
      "why_now": "CRV funding annualized \u2248 -42.26%, 24h volume \u2248 $3,130,455.",
    ...
    {
      "idea_id": "2026-07-09-QTF-MORNING-03",
