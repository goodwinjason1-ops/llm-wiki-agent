---
title: AI Quant Morning Brief - 2026-07-20
created: 2026-07-20
updated: 2026-07-19T20:00:55+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-20
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 64515.0000 | -0.50% | 1.15% | 1.53% | range/chop |
| ETHUSDT | 1864.6300 | 0.10% | 3.20% | 8.97% | bullish-momentum |
| SOLUSDT | 75.9600 | 0.60% | -1.25% | 8.95% | range/chop |
...
- **Idea ID:** `2026-07-20-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: ETHUSDT 7d=3.20%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-1.25%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.
...
- **Idea ID:** `2026-07-20-QTF-MORNING-02`
...
- **Why now:** Screened example CASHCAT: funding annualized ≈ 168.72%, 24h volume ≈ $26,438,890. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-20-QTF-MORNING-03`
...
|---|---:|---:|---:|
| CASHCAT | 168.72% | $26,438,890 | 0.074058 |
| BTC | 10.95% | $891,941,387 | 64508.0 |
| ETH | 10.95% | $259,355,968 | 1864.6 |
| HYPE | 10.95% | $149,642,596 | 61.105 |
| ZEC | 10.95% | $58,219,915 | 550.67 |

- Polymarket headline scan error: `URLError(gaierror(11002, 'getaddrinfo failed'))`
...
```json
{
  "run_id": "20260719T200054Z",
  "generated_at": "2026-07-19T20:00:55+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-20-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: ETHUSDT 7d=3.20%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-1.25%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-20-QTF-MORNING-02",
      ...
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; CASHCAT is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example CASHCAT: funding annualized \u2248 168.72%, 24h volume \u2248 $26,438,890. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-20-QTF-MORNING-03",
