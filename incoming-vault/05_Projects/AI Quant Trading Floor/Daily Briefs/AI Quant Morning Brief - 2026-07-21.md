---
title: AI Quant Morning Brief - 2026-07-21
created: 2026-07-21
updated: 2026-07-21T01:28:47+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-21
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 65475.0000 | 0.33% | 0.67% | 3.42% | bullish-momentum |
| ETHUSDT | 1910.8200 | 0.33% | 1.00% | 11.96% | bullish-momentum |
| SOLUSDT | 77.9800 | 0.15% | 0.14% | 7.60% | range/chop |
...
- **Idea ID:** `2026-07-21-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: ETHUSDT 7d=1.00%, regime=bullish-momentum. Laggard: SOLUSDT 7d=0.14%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.
...
### 2. Funding-Rate Extremes / Carry Validation Desk — Funding-rate-extremes universe (current screened example: ACE)

- **Idea ID:** `2026-07-21-QTF-MORNING-02`
...
- **Thesis:** Test the pre-defined funding-rate-extremes / carry rule; ACE is one currently screened observation, not the edge itself or a standing trade thesis.
- **Why now:** Screened example ACE: funding annualized ≈ -471.98%, 24h volume ≈ $10,301,031. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-21-QTF-MORNING-03`
...
|---|---:|---:|---:|
| ACE | -471.98% | $10,301,031 | 0.1103 |
| HEMI | 156.35% | $2,649,219 | 0.006551 |
| CASHCAT | 91.24% | $19,752,061 | 0.080718 |
| ZRO | 80.77% | $2,251,337 | 0.79524 |
| ETH | 10.95% | $908,572,937 | 1910.24 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will Bitcoin dip to $25,000 by December 31, 2026? | $89,086 | 2027-01-01 |
| Will Carlos Roberto Massa Júnior finish in third place in the first round of the 2026 Brazilian presidential election? | $21,032 | 2026-10-04 |
...
```json
{
  "run_id": "20260721T012842Z",
  "generated_at": "2026-07-21T01:28:47+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-21-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: ETHUSDT 7d=1.00%, regime=bullish-momentum. Laggard: SOLUSDT 7d=0.14%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-21-QTF-MORNING-02",
      "desk": "Funding-Rate Extremes / Carry Validation Desk",
      "source_notes": [
        "[[CASHCAT Funding Persistence Evidence Review - 2026-07-14]]",
        "[[QTF Edge-First Production Mandate]]"
      ],
      "market": "Funding-rate-extremes universe (current screened example: ACE)",
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; ACE is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example ACE: funding annualized \u2248 -471.98%, 24h volume \u2248 $10,301,031. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-21-QTF-MORNING-03",
