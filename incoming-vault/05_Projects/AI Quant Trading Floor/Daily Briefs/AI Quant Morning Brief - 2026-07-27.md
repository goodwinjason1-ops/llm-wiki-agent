---
title: AI Quant Morning Brief - 2026-07-27
created: 2026-07-27
updated: 2026-07-26T20:00:56+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-27
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 64700.7000 | 0.52% | -0.05% | 7.65% | range/chop |
| ETHUSDT | 1914.4700 | 2.12% | 2.25% | 21.27% | bullish-momentum |
| SOLUSDT | 75.3600 | 1.13% | -1.32% | 4.81% | range/chop |
...
- **Idea ID:** `2026-07-27-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: ETHUSDT 7d=2.25%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-1.32%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.
...
### 2. Funding-Rate Extremes / Carry Validation Desk — Funding-rate-extremes universe (current screened example: XMR)

- **Idea ID:** `2026-07-27-QTF-MORNING-02`
...
- **Thesis:** Test the pre-defined funding-rate-extremes / carry rule; XMR is one currently screened observation, not the edge itself or a standing trade thesis.
- **Why now:** Screened example XMR: funding annualized ≈ 108.97%, 24h volume ≈ $3,392,315. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-27-QTF-MORNING-03`
...
|---|---:|---:|---:|
| XMR | 108.97% | $3,392,315 | 356.24 |
| KAITO | -40.02% | $20,649,111 | 1.1707 |
| MON | -42.94% | $1,728,542 | 0.020864 |
| ZEC | -18.94% | $19,413,434 | 491.8 |
| INJ | -21.71% | $1,416,800 | 4.87386 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will 2 Fed rate hikes happen in 2026? | $13,408 | 2026-12-31 |
| Will Bitcoin reach $75,000 by December 31, 2026? | $39,940 | 2027-01-01 |
| Will Carlos Roberto Massa Júnior finish in third place in the first round of the 2026 Brazilian presidential election? | $25,264 | 2026-10-04 |
...
```json
{
  "run_id": "20260726T200052Z",
  "generated_at": "2026-07-26T20:00:57+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-27-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: ETHUSDT 7d=2.25%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-1.32%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-27-QTF-MORNING-02",
      "desk": "Funding-Rate Extremes / Carry Validation Desk",
      "source_notes": [
        "[[CASHCAT Funding Persistence Evidence Review - 2026-07-14]]",
        "[[QTF Edge-First Production Mandate]]"
      ],
      "market": "Funding-rate-extremes universe (current screened example: XMR)",
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; XMR is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example XMR: funding annualized \u2248 108.97%, 24h volume \u2248 $3,392,315. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-27-QTF-MORNING-03",
