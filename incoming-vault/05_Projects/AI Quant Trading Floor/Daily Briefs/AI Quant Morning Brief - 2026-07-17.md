---
title: AI Quant Morning Brief - 2026-07-17
created: 2026-07-17
updated: 2026-07-16T20:00:19+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-17
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 64270.3000 | -0.75% | 1.66% | -2.14% | range/chop |
| ETHUSDT | 1875.5300 | -2.21% | 7.47% | 4.60% | mixed |
| SOLUSDT | 75.8400 | -1.86% | -2.83% | 3.14% | range/chop |
...
- **Idea ID:** `2026-07-17-QTF-MORNING-01`
...
- **Why now:** Current leader ETHUSDT: 7d=7.47%, 30d=4.60%, regime=mixed. This is diagnostic context only; ETH remains a benchmark/control.
...
- **Idea ID:** `2026-07-17-QTF-MORNING-02`
...
- **Why now:** Screened example CASHCAT: funding annualized ≈ 1248.23%, 24h volume ≈ $49,410,508. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-17-QTF-MORNING-03`
...
|---|---:|---:|---:|
| CASHCAT | 1248.23% | $49,410,508 | 0.087414 |
| kBONK | -1094.20% | $5,677,180 | 0.003439 |
| ZRO | 53.52% | $4,174,543 | 0.81512 |
| HYPE | -33.02% | $426,318,913 | 62.221 |
| KAITO | -37.33% | $7,882,094 | 0.85288 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will the price of Ethereum be above $1,500 on July 21? | $7,931 | 2026-07-21 |
| Will the price of Ethereum be above $1,400 on July 21? | $3,022 | 2026-07-21 |
...
```json
{
  "run_id": "20260716T200015Z",
  "generated_at": "2026-07-16T20:00:20+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-17-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule; do not create an asset-specific thesis from recent returns.",
      "why_now": "Current leader ETHUSDT: 7d=7.47%, 30d=4.60%, regime=mixed. This is diagnostic context only; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-17-QTF-MORNING-02",
      ...
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; CASHCAT is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example CASHCAT: funding annualized \u2248 1248.23%, 24h volume \u2248 $49,410,508. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-17-QTF-MORNING-03",
