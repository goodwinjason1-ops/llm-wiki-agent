---
title: AI Quant Morning Brief - 2026-07-25
created: 2026-07-25
updated: 2026-07-24T20:00:14+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-25
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 64220.6000 | -1.35% | 0.44% | 5.15% | range/chop |
| ETHUSDT | 1863.5100 | -0.78% | 1.18% | 14.86% | bullish-momentum |
| SOLUSDT | 73.9400 | -2.54% | -1.47% | 8.56% | range/chop |
...
- **Idea ID:** `2026-07-25-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: ETHUSDT 7d=1.18%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-1.47%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.
...
- **Idea ID:** `2026-07-25-QTF-MORNING-02`
...
- **Why now:** Screened example ACE: funding annualized ≈ -1952.92%, 24h volume ≈ $1,417,747. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-25-QTF-MORNING-03`
...
|---|---:|---:|---:|
| ACE | -1952.92% | $1,417,747 | 0.1026 |
| CASHCAT | 468.48% | $11,278,093 | 0.050938 |
| MET | -133.99% | $1,000,528 | 0.15557 |
| WLD | -95.83% | $12,146,587 | 0.36797 |
| APT | -48.15% | $1,158,423 | 0.6023 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will Carlos Roberto Massa Júnior finish in third place in the first round of the 2026 Brazilian presidential election? | $21,776 | 2026-10-04 |
...
```json
{
  "run_id": "20260724T200010Z",
  "generated_at": "2026-07-24T20:00:14+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-25-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: ETHUSDT 7d=1.18%, regime=bullish-momentum. Laggard: SOLUSDT 7d=-1.47%, regime=range/chop. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-25-QTF-MORNING-02",
      ...
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; ACE is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example ACE: funding annualized \u2248 -1952.92%, 24h volume \u2248 $1,417,747. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-25-QTF-MORNING-03",
