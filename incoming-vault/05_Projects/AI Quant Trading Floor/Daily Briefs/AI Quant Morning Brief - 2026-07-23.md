---
title: AI Quant Morning Brief - 2026-07-23
created: 2026-07-23
updated: 2026-07-22T20:00:35+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-23
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 65945.4000 | -0.92% | 1.84% | 3.01% | bullish-momentum |
| ETHUSDT | 1927.2500 | -0.16% | 0.49% | 11.52% | bullish-momentum |
| SOLUSDT | 77.7300 | -0.52% | 0.58% | 8.00% | range/chop |
...
- **Idea ID:** `2026-07-23-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: BTCUSDT 7d=1.84%, regime=bullish-momentum. Laggard: ETHUSDT 7d=0.49%, regime=bullish-momentum. Both directions are evidence; ETH remains a benchmark/control.
...
### 2. Funding-Rate Extremes / Carry Validation Desk — Funding-rate-extremes universe (current screened example: JUP)

- **Idea ID:** `2026-07-23-QTF-MORNING-02`
...
- **Thesis:** Test the pre-defined funding-rate-extremes / carry rule; JUP is one currently screened observation, not the edge itself or a standing trade thesis.
- **Why now:** Screened example JUP: funding annualized ≈ -37.21%, 24h volume ≈ $1,103,970. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-23-QTF-MORNING-03`
...
|---|---:|---:|---:|
| JUP | -37.21% | $1,103,970 | 0.1905 |
| BTC | 10.95% | $1,934,075,091 | 65923.0 |
| VIRTUAL | -18.44% | $3,073,396 | 0.63234 |
| ETH | 10.91% | $854,340,865 | 1926.5 |
| HYPE | 10.95% | $453,459,808 | 59.28 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will Nigel Farage win the Clacton by-election? | $139,212 | 2027-06-30 |
| Will Carlos Roberto Massa Júnior finish in third place in the first round of the 2026 Brazilian presidential election? | $24,758 | 2026-10-04 |
...
```json
{
  "run_id": "20260722T200031Z",
  "generated_at": "2026-07-22T20:00:35+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-23-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: BTCUSDT 7d=1.84%, regime=bullish-momentum. Laggard: ETHUSDT 7d=0.49%, regime=bullish-momentum. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-23-QTF-MORNING-02",
      "desk": "Funding-Rate Extremes / Carry Validation Desk",
      "source_notes": [
        "[[CASHCAT Funding Persistence Evidence Review - 2026-07-14]]",
        "[[QTF Edge-First Production Mandate]]"
      ],
      "market": "Funding-rate-extremes universe (current screened example: JUP)",
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; JUP is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example JUP: funding annualized \u2248 -37.21%, 24h volume \u2248 $1,103,970. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-23-QTF-MORNING-03",
