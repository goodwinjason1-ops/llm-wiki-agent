---
title: AI Quant Morning Brief - 2026-07-29
created: 2026-07-29
updated: 2026-07-28T20:00:27+00:00
type: daily-brief
status: generated
tags: [quant, morning-brief, read-only, guardrails]
---

# AI Quant Morning Brief - 2026-07-29
...
|---|---:|---:|---:|---:|---|
| BTCUSDT | 63922.2000 | 0.27% | -3.96% | 7.30% | mixed |
| ETHUSDT | 1923.0100 | 1.61% | -0.38% | 22.33% | range/chop |
| SOLUSDT | 74.3300 | 0.18% | -4.88% | 4.10% | mixed |
...
- **Idea ID:** `2026-07-29-QTF-MORNING-01`
...
- **Why now:** Bidirectional scan — Leader: ETHUSDT 7d=-0.38%, regime=range/chop. Laggard: SOLUSDT 7d=-4.88%, regime=mixed. Both directions are evidence; ETH remains a benchmark/control.
...
### 2. Funding-Rate Extremes / Carry Validation Desk — Funding-rate-extremes universe (current screened example: TRUMP)

- **Idea ID:** `2026-07-29-QTF-MORNING-02`
...
- **Thesis:** Test the pre-defined funding-rate-extremes / carry rule; TRUMP is one currently screened observation, not the edge itself or a standing trade thesis.
- **Why now:** Screened example TRUMP: funding annualized ≈ -35.05%, 24h volume ≈ $2,816,432. This observation only enters the funding-extremes test queue.
...
- **Idea ID:** `2026-07-29-QTF-MORNING-03`
...
|---|---:|---:|---:|
| TRUMP | -35.05% | $2,816,432 | 1.4787 |
| FET | -32.49% | $2,017,801 | 0.13915 |
| ADA | -26.58% | $4,675,603 | 0.15903 |
| BTC | 10.95% | $2,144,826,305 | 63895.0 |
| ETH | 10.95% | $1,179,699,725 | 1922.0 |

### Polymarket high-volume macro/crypto headlines
| Question | Liquidity | End |
|---|---:|---|
| Will Brazil’s Annual Inflation in 2026 be between 4.00% and 4.49%? | $3,774 | 2027-01-12 |
...
```json
{
  "run_id": "20260728T200022Z",
  "generated_at": "2026-07-28T20:00:27+00:00",
  "ideas": [
    {
      "idea_id": "2026-07-29-QTF-MORNING-01",
      ...
      "venue": "Bybit public data; no auth",
      "thesis": "Validate the pre-defined TTM-01 cross-sectional momentum rule. Momentum must be bidirectional: track both top gainers (trend continuation long) and worst losers (trend continuation short / mean-reversion candidates). Do not create an asset-specific thesis from recent returns.",
      "why_now": "Bidirectional scan \u2014 Leader: ETHUSDT 7d=-0.38%, regime=range/chop. Laggard: SOLUSDT 7d=-4.88%, regime=mixed. Both directions are evidence; ETH remains a benchmark/control.",
    ...
    {
      "idea_id": "2026-07-29-QTF-MORNING-02",
      "desk": "Funding-Rate Extremes / Carry Validation Desk",
      "source_notes": [
        "[[CASHCAT Funding Persistence Evidence Review - 2026-07-14]]",
        "[[QTF Edge-First Production Mandate]]"
      ],
      "market": "Funding-rate-extremes universe (current screened example: TRUMP)",
      "venue": "Hyperliquid public info endpoint; no auth",
      "thesis": "Test the pre-defined funding-rate-extremes / carry rule; TRUMP is one currently screened observation, not the edge itself or a standing trade thesis.",
      "why_now": "Screened example TRUMP: funding annualized \u2248 -35.05%, 24h volume \u2248 $2,816,432. This observation only enters the funding-extremes test queue.",
    ...
    {
      "idea_id": "2026-07-29-QTF-MORNING-03",
